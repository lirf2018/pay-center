...
public class GeneralDaoImpl2 implements IGeneralDao2 {
    ...
    private Session getSession() {
        return entityManagerFactoryDb2.createEntityManager().unwrap(Session.class);
    }
...
//        System.out.println("------------------------>查询页:"+currePage);
        // 分页查询结果
        Query query = entityManagerFactoryDb2.createEntityManager().createNativeQuery(sqlQuery);
        ...
        Query countQuery = entityManagerFactoryDb2.createEntityManager().createNativeQuery(sqlCount);
